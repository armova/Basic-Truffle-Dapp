...
window.App = {
  start: function() {
    ...
    // Bootstrap the HelloWorld abstraction for Use.
  ...
  setStatus: function(message) {
    ...
    status2.innerHTML = `New account fuel level is: ${web3.eth.getBalance(account).toNumber()}`;
  },
  ...
  sendCoin: function() {
    ...
    HelloWorld.deployed().then(function(instance) {
      meta = instance;
      return meta.deposit(amount, {from: account});
    })
    .then(function() {
